...
public class OrderService {
    ...
    public Order findById(Long id){
        Optional<Order> obj = repository.findById(id); // O tipo Optional é uma classe do Java que representa um valor que pode ou não estar presente. Ele é usado para evitar NullPointerException.
